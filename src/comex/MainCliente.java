...
public class MainCliente {
	...
	public static void main(String[] args) {
		Cliente cli1 = new Cliente(1, 999999999, "(11)947491111", "Ana Maria", "AV Faria Lima", "60", "Sobrado",
				"Pinheiros", "Foz do Iguaçu", "ES");
		Cliente cli2 = new Cliente(2, 888888888, "(11)947492222", "Eli Zangela", "AV Francisco Morato", "145", "Casa", "Centro",
				"Santo André", "PR");
		Cliente cli3 = new Cliente(3, 777777777, "(11)947493333", "Gabi Ruta", "AV Siumare", "1815", "Apto.75",
