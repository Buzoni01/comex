...
public class MainIntemPedido {
	...
	public static void main(String[] args) {
		ItemPedido c01 = new ItemPedido(100.00, 11, "Notebook ", 1, TipoDesconto.QUANTIDADE);
		ItemPedido c02 = new ItemPedido(100.00, 1, "Mouse USB", 1, TipoDesconto.PROMOCAO);
		ItemPedido c03 = new ItemPedido(100.00, 12, "MacBook X", 1, TipoDesconto.NENHUM);
...
/*	
		System.out.println(c02.precoTotalSemDesconto());
		System.out.println(c02.calculaDesconto(0));
		System.out.println(c02.precoTotalComDesconto(0));
		
		System.out.println(c03.precoTotalSemDesconto());
		System.out.println(c03.calculaDesconto(0));
		System.out.println(c03.precoTotalComDesconto(0));
*/
	}
}
